...
module.exports = {
  ...
  onChat: async function ({ api, event, args, Threads, usersData }) {
    ...
    const messages = [
      ...
      "🦋𝗠𝗮𝗹👀🔪 বট এর help list dekhte type koron %2help",
      "কিরে বলদ তুই এইখানে 🙂",
      " আমাকেD চিনো না জানু? মনু",
      ...
      "Boss Gojo Orupe Piw Piw er chipay😜 ",
      "bashi dakle boss Gojo Orupe Piw Piw ke bole dimu😒 ",
      ...
      "𝗛𝗶𝗶 𝗶 𝗮𝗺 𝗣𝗶𝘄 𝗣𝗶𝘄 𝗖𝗵𝗮𝘁 𝗯𝗼𝘁 𝗰𝗮𝗻 𝗶 𝗵𝗲𝗹𝗽 𝘆𝗼𝘂!🤖 ",
      "𝗲𝘁𝗼 𝗯𝗼𝘁 𝗯𝗼𝘁 𝗻𝗮 𝗸𝗼𝗿𝗲 𝗮𝗺𝗮𝗿 𝗯𝗼𝘀𝘀 𝗴𝗼𝗷𝗼 𝗼𝗿𝘂𝗽𝗲 𝗽𝗶𝘄 𝗽𝗶𝘄 𝗸𝗲 𝘁𝗮𝗸𝗮 𝗼 𝘁𝗼 𝗽𝗮𝗧𝗵𝗮𝘁𝗲 𝗽𝗮𝗿𝗼😒🥳🥳 ",
